...
class Home extends Component {
    ...
    componentDidMount() {
        ...
        //alert(sid);
        return fetch(ip + '/student/home/' + sid)
            .then((res) => res.json())
            .then((res) => {
            ...
            <View style={styles.container}>
                ...
                <View style={styles.main}>
                    ...
                    <View style={styles.textContainer}>
                        ...
                        <Text > Level   {this.state.informations.level}  </Text>
                        <Text> Class Number  {this.state.informations.classnumber}  </Text>
                    </View>
                </View>
            </View>
        );
