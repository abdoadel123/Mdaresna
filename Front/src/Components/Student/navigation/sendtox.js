...
class Sendto extends Component {
    ...
    sendmymessage = () => {
        const data = {
            toid:this.props.navigation.state.params.toid ,
    ...
    render() {
        return (
            <Container>
                ...
                <Content>
                    <Text style={{ height: 70, margin: 5, borderWidth: 2, backgroundColor: '#eee', borderColor: '#eee', color: '#008080', paddingTop: 20 }}>To :   {this.props.navigation.state.params.toname}</Text>
